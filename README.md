# Server Side Pagination Front End <img src="assets/icon.png" alt="header-logo" width="27px"/>

This project was bootstrapped with [Create React App](https://github.com/facebook/create-react-app).

This project shows how to handle **server-side pagination** with a **react mui front end.** 
...
- Clone the project using `https://github.com/PubuduJ/server-side-pagination-front-end.git` terminal command.
